...
public class TypeCasting {
	// Dont run this program - Just type and understanding how casting works public
...
//	byte c = i;// will not accept - because lower type cannot be put in higher
	...
	byte x = 10;
	byte y = 20;
//	byte sum = x * y; // Error is thrown because when two bytes are used in a arthmetic operation, the
